...
void mul_sym(double * restrict C, register double * restrict A,
...
void mult_mat_trans_tri(double * restrict B, double * restrict A, register size_t n) {
    register size_t i;
    register size_t j;
